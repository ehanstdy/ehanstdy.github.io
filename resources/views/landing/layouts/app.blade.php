...
<head>
    ...
    <meta name="title" content="SNOWFLAKES - Top Up Termurah Instant Buka 24 Jam">
    <meta name="description"
        content="SNOWFLAKES - Top Up Instant Game &amp; Voucher termurah, terpercaya, dan aman legal 100% open 24 Jam">
    <meta property="og:type" content="website">
    <meta property="og:url" content="index.html">
    <meta property="og:title" content="SNOWFLAKES - Top Up Termurah Instant Buka 24 Jam">
    <meta property="og:description"
        content="SNOWFLAKES - Top Up Instant Game &amp; Voucher termurah, terpercaya, dan aman legal 100% open 24 Jam">
    <meta property="og:image" content="favicon.ico">
    <meta name="robots" content="index, follow">
    <meta content="desktop" name="device">
    <meta name="author" content="SNOWFLAKES">
    <meta name="coverage" content="Worldwide">
    <meta name="apple-mobile-web-app-title" content="SNOWFLAKES - Top Up Termurah Instant Buka 24 Jam">
        ...
        <div class="container">
            <ul class="navbar-nav ms-auto nav-stacked">
                ...
                <div class="d-flex my-2">
                    <a class="btn btn-primary but-side" href="{{ route('login') }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('landing.history-order') }}" class="nav-link text-white ">
                        <i class="fa fa-shopping-cart"></i> Riwayat Pesanan</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark shadow mb-2" aria-labelledby="navUser">
                        ...
                        <li><a class="dropdown-item text-white" href="{{ route('home') }}" id="header_saldo"><i
                            class="fa fa-user-secret"></i> Admin Menu</a></li>
                        @endif

                        @if (auth()->user()->role == "User")
                        <li><a class="dropdown-item text-white" href="{{ route('landing.profil') }}"><i class="fa fa-user"></i> Profil</a></li>
                        <li><a class="dropdown-item text-white" href="{{ route('landing.changePassword') }}"><i class="fa fa-cog"></i> Ganti Password</a></li>
                        <li>
                            @endif
                        ...
                        <li>
                            <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="dropdown-item text-white" href="{{ route('logout') }}"></i> Logout</button>
                            </form>
                        </li>
                    </ul>
                </li>
    ...
    <div class="content">
        <header class="mb-5">
            <nav class="navbar navbar-expand-lg fixed-top text-white bg-dark navbar-dark shadow d-block d-sm-none">
                ...
                <div class="d-flex my-2">
                    <a class="btn btn-primary but-side" href="{{ route('login') }}"><i class="fa fa-sign-in-alt"
                            aria-hidden="true"></i>
                        Login</a>
                </div>
                @endif
                ...
                <div class="d-flex my-2">
                    <a class="btn btn-primary but-side" href="{{ route('logout') }}"
                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
                            class="fa fa-sign-out-alt" aria-hidden="true"></i>
                        Logout</a>
            ...
            <div class="container mt-5">
                <div class="row">
                        ...
                        <div class="mt-2">
                            <table>
                                <tr>
                                    ...
                                    <td valign="top">: </td>
                                    <td style="padding-left:5px"><a href="https://web.whatsapp.com/" target="_blank"
                                            class="text-white">123456789</a></td>
                                </tr>
                                <tr>
                                    <td><i class="fa fa-instagram"></i> Instagram</td>
                                    <td valign="top">: </td>
                                    <td style="padding-left:5px"><a href="https://www.instagram.com/" class="text-white"
                                            target="_blank">snowflakesstore</a></td>
                                </tr>
                                <tr>
                                    <td><i class="fa fa-envelope-o"></i> E-mail</td>
                                    <td valign="top">: </td>
                                    <td style="padding-left:5px"><a href="https://www.google.com/intl/en-US/gmail/about/" class="text-white"><span
                                                class="__cf_email__"
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="mt-3">
                            <img src="{{ asset('assets/images/bca.png') }}" class="snowflakes-pgimg">
                            <img src="{{ asset('assets/images/Dana.png') }}" class="snowflakes-pgimg">
                            <br>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" id="footer-credit">
                    <div class="col">
                        <div class="container mt-2 mb-2 text-center">
                            <small>
                                Copyright &copy; 2024 <a href="/" class="text-white">Snowflakes Game Store</a>
                                All Rights Reserved.
                            </small>
                        </div>
                    </div>
